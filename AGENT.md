...
- **Maintain `project-manager/tasks.md` as the central project log: record pending, upcoming, and completed tasks; update the status and categorize them into 'Done', 'In Progress', and 'Planned' sections on every change; and note the next steps in your development workflow.**
